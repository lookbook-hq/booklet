...
#       before { root = Node.new("root") }

#       describe "#new" do
#         it "must have a string id provided" do
#           assert_raises { Node.new }
#           assert_raises { Node.new(1) }

#           assert_instance_of Node, Node.new("root")
#         end
#       end

#       describe "#add" do
#         it "accepts child nodes" do
#           child = Node.new("child_1")
#           root.add child
